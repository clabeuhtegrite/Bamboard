 ...
 * Size: 20 px
 * Bpp: 4
 * Opts: --font /tmp/bbfonts/Montserrat-Medium.ttf -r 0x20-0x7F -r 0xA0-0xFF --font /tmp/bbfonts/FontAwesome5.woff -r 0xF00B,0xF00C,0xF013,0xF015,0xF019,0xF043,0xF053,0xF054,0xF071,0xF079,0xF1EB,0xF2ED --size 20 --bpp 4 --no-kerning --no-compress --format lvgl --force-fast-kern-format --lv-include lvgl.h -o firmware/src/ui/fonts/bb_font_20.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 14987, .adv_w = 320, .box_w = 20, .box_h = 19, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 15177, .adv_w = 320, .box_w = 20, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 15327, .adv_w = 320, .box_w = 20, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 15537, .adv_w = 360, .box_w = 23, .box_h = 19, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 15756, .adv_w = 320, .box_w = 20, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 15966, .adv_w = 220, .box_w = 14, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 16113, .adv_w = 200, .box_w = 11, .box_h = 19, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 16218, .adv_w = 200, .box_w = 11, .box_h = 19, .ofs_x = 1, .ofs_y = -2},
    {.bitmap_index = 16323, .adv_w = 360, .box_w = 24, .box_h = 21, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 16575, .adv_w = 400, .box_w = 26, .box_h = 16, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 16783, .adv_w = 400, .box_w = 25, .box_h = 19, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 17021, .adv_w = 280, .box_w = 18, .box_h = 21, .ofs_x = 0, .ofs_y = -3}
};
...
static const uint16_t unicode_list_2[] = {
    0x0, 0x1, 0x8, 0xa, 0xe, 0x38, 0x48, 0x49,
    0x66, 0x6e, 0x1e0, 0x2e2
};
...
static const lv_font_fmt_txt_cmap_t cmaps[] =
{
    ...
    {
        .range_start = 61451, .range_length = 739, .glyph_id_start = 192,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t bb_font_20 = {
#else
lv_font_t bb_font_20 = {
#endif
