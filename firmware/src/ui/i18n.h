...
enum class Str : uint16_t {
    // tabs / screen titles
    TAB_LIVE, TAB_PRINTERS, TAB_HISTORY, TAB_SETTINGS,
    ...
    // settings
    BRIGHTNESS, BRIGHTNESS_FMT, FIRMWARE, LOCAL_IP, WIFI_RSSI, UPTIME,
    FACTORY_RESET, CONFIRM_RESET, LANGUAGE,
    // overlays
