...
(function () {
  ...
  var DICTS = /*i18n:json*/{
    "es": {
      ...
      "feat.local.h": "Local primero y privado", "feat.local.p": "Habla REST + WebSocket con tu propia instancia de Bambuddy. Tus impresoras se mantienen fuera de cualquier nube de terceros — tus datos nunca salen de tu red salvo que elijas HTTPS.",
      ...
      "scr.desc.settings": "<b>Ajustes.</b> URL de Bambuddy y la versión + tiempo activo del servidor, IP local, RSSI Wi-Fi y tiempo activo del dispositivo, un selector de brillo 1–5 y un restablecimiento de fábrica con doble toque.",
      ...
      "how.rt.h": "Push en tiempo real.", "how.rt.p": "Se suscribe al WebSocket de Bambuddy para recibir tramas <code>printer_status</code> al instante, con sondeo REST como red de seguridad — así una alerta HMS aparece en un salto de red, no en un ciclo de sondeo.",
    ...
    "fr": {
      ...
      "feat.local.h": "Local d'abord et privé", "feat.local.p": "Parle REST + WebSocket à votre propre instance Bambuddy. Vos imprimantes restent hors de tout cloud tiers — vos données ne quittent jamais votre réseau, sauf si vous choisissez HTTPS.",
      ...
      "scr.desc.settings": "<b>Réglages.</b> URL Bambuddy et version + temps de fonctionnement du serveur, IP locale, RSSI Wi-Fi et temps de fonctionnement de l'appareil, un sélecteur de luminosité 1–5 et une réinitialisation d'usine en deux touches.",
      ...
      "how.rt.h": "Push temps réel.", "how.rt.p": "S'abonne au WebSocket de Bambuddy pour des trames <code>printer_status</code> instantanées, avec un sondage REST en filet de sécurité — ainsi une alerte HMS apparaît en un saut réseau, pas en un cycle de sondage.",
    ...
    "pt": {
      ...
      "feat.local.h": "Local primeiro e privado", "feat.local.p": "Fala REST + WebSocket com a sua própria instância Bambuddy. As suas impressoras ficam fora de qualquer nuvem de terceiros — os seus dados nunca saem da sua rede a menos que escolha HTTPS.",
      ...
      "scr.desc.settings": "<b>Definições.</b> URL do Bambuddy e a versão + tempo de atividade do servidor, IP local, RSSI Wi-Fi e tempo de atividade do dispositivo, um seletor de brilho 1–5 e uma reposição de fábrica com duplo toque.",
      ...
      "how.rt.h": "Push em tempo real.", "how.rt.p": "Subscreve o WebSocket do Bambuddy para tramas <code>printer_status</code> instantâneas, com sondagem REST como rede de segurança — assim um alerta HMS aparece num salto de rede, não num ciclo de sondagem.",
    ...
    "de": {
      ...
      "feat.local.h": "Lokal zuerst und privat", "feat.local.p": "Spricht REST + WebSocket mit deiner eigenen Bambuddy-Instanz. Deine Drucker bleiben aus jeder Cloud von Dritten heraus — deine Daten verlassen dein Netzwerk nie, außer du wählst HTTPS.",
      ...
      "scr.desc.settings": "<b>Einstellungen.</b> Bambuddy-URL und Version + Laufzeit des Servers, lokale IP, WLAN-RSSI und Gerätelaufzeit, ein Helligkeitsregler 1–5 und ein Werksreset mit zwei Tipps.",
      ...
      "how.rt.h": "Echtzeit-Push.", "how.rt.p": "Abonniert Bambuddys WebSocket für sofortige <code>printer_status</code>-Frames, mit REST-Abfrage als Sicherheitsnetz — so erscheint ein HMS-Alarm in einem Netzwerk-Hop, nicht in einem Abfragezyklus.",
